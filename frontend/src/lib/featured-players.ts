...
const COMPLETE_PLAYER_MAP = {
  ...
  DET: featuredPlayer("4374302", "Amon-Ra St. Brown", "WR", "amon-ra-st-brown"),
  ...
  NYG: featuredPlayer("4595348", "Malik Nabers", "WR", "malik-nabers"),
...
export const FEATURED_PLAYERS: Readonly<Record<string, FeaturedPlayer>> =
  COMPLETE_PLAYER_MAP;
